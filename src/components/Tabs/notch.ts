/** Shared wavy notch geometry — tab bar + pricing table bridge. */
export const TAB_NOTCH_CLIP_PATH =
...
export const TAB_NOTCH_CLIP_TRANSFORM =
  "scale(0.0049285362247413 0.021978021978022)";

export const TAB_NOTCH_WIDTH = "8.6em";
export const TAB_NOTCH_HEIGHT = "2.15em";
