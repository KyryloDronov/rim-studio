...
const PATH = "/services/caliper-painting";
const PAGE_KEY = "caliperPainting" as const;

export async function generateMetadata({
  params,
}: PageProps<"/[lang]/services/caliper-painting">) {
  const { lang } = await params;
  return buildServiceLandingMetadata(lang, PAGE_KEY, PATH);
}

export default async function CaliperPaintingPage({
  params,
}: PageProps<"/[lang]/services/caliper-painting">) {
  const { lang } = await params;
