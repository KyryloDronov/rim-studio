...
const DEFAULT_VIDEO_SRC = "/video/istockphoto-2160780876-640_adpp_is.mp4";
...
const infoVariants: Variants = {
  ...
  open: {
    opacity: 1,
    y: 0,
    transition: { duration: 0.6, delay: 0.65, ease: easeOutQuart },
  },
};
  ...
  return (
    ...
    >
      ...
      <div className={styles.content}>
        ...
        >
          <p className={styles.infoLabel}>Contact us</p>
          <a
